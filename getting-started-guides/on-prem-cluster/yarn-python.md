...
/tmp/xgboost4j_spark_python/libs/cudf-0.17-cuda10-2.jar
/tmp/xgboost4j_spark_python/libs/main.py
/tmp/xgboost4j_spark_python/libs/rapids-4-spark_2.12-0.3.0.jar
/tmp/xgboost4j_spark_python/libs/samples.zip
/tmp/xgboost4j_spark_python/libs/xgboost4j_3.0-1.3.0-0.1.0.jar
/tmp/xgboost4j_spark_python/libs/xgboost4j-spark_3.0-1.3.0-0.1.0.jar
```
...
export SPARK_JARS=${LIBS_PATH}/cudf-0.17-cuda10-2.jar
...
# additional jars for XGBoost4J example
export SPARK_JARS=${LIBS_PATH}/cudf-0.17-cuda10-2.jar,${LIBS_PATH}/xgboost4j_3.0-1.3.0-0.1.0.jar,${LIBS_PATH}/xgboost4j-spark_3.0-1.3.0-0.1.0.jar
